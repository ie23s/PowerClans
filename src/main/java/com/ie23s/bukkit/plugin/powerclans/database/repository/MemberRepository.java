...
public interface MemberRepository {
     ...
     *
     * @param member DTO with clan name, player name, and moderator flag
     */
     ...
     *
     * @param clanName   clan the member belongs to
     * @param memberName player name of the member
     * @param isModer    new moderator status
     */
    void updateModer(String clanName, String memberName, boolean isModer) throws SQLException;
     ...
     */
    void delete(String clanName, String memberName) throws SQLException;

    /**
     * Removes all members of a clan (used during disband).
     *
     * @param clanName name of the disbanded clan
     */
    void deleteByClan(String clanName) throws SQLException;
}
